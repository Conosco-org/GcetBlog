/**
 * Sample Posts Creation Script
 * Creates 5 sample published posts for the blog
 * Usage: node scripts/create-sample-posts.js
 * Note: Make sure your dev server is running before executing this script
 */
...
async function createSamplePosts() {
  ...
  console.log(`\n✨ Successfully created ${created} out of ${posts.length} sample posts!`)
