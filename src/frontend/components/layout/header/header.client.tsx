'use client'
import { useHeaderTheme } from '@frontend/providers'
...
import { AuthButton } from '@frontend/components/layout/header/auth-button'
import { GlobalSearchBar } from '@frontend/components/layout/global-search-bar'
