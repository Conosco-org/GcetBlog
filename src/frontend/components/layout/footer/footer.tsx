...
import type { Footer } from '@shared/types/payload-types'

import { ThemeSelector } from '@frontend/providers/Theme/ThemeSelector'
import { CMSLink } from '@frontend/components/shared/link'
