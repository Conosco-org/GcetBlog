...
interface UserActionsProps {
  ...
  changeUserRole: (userId: string, newRole: 'contributor' | 'editor') => Promise<{ success: boolean; message: string }>
  deleteUser: (userId: string) => Promise<{ success: boolean; message: string }>
  toggleAdminStatus: (userId: string) => Promise<{ success: boolean; message: string }>
  toggleCanManageAdmins: (userId: string) => Promise<{ success: boolean; message: string }>
}

export function UserActions({
  user,
  currentUserId,
  currentUserCanManageAdmins = false,
  changeUserRole,
  deleteUser,
  toggleAdminStatus,
  toggleCanManageAdmins,
}: UserActionsProps) {
