      ...
      <div className="flex h-16 items-center px-4 gap-4">
        ...
        <div className="ml-auto flex items-center gap-3">
          ...
          <div className="flex items-center gap-3 px-3 py-2 rounded-lg border bg-card">
            <div className="flex items-center justify-center w-9 h-9 rounded-full bg-gradient-to-br from-red-500 to-orange-600 text-white font-semibold text-sm">
            ...
            <div className="flex flex-col min-w-0">
              ...
              <Badge variant="outline" className="text-xs h-5 border-red-500/30 text-red-600 dark:text-red-400">
                {user.role}
              </Badge>
            </div>
          </div>
