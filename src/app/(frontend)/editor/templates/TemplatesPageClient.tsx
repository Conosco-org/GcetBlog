...
export function TemplatesPageClient({
  ...
  const updateParams = (updates: Record<string, string>) => {
    ...
    router.push(`/editor/templates?${params.toString()}`)
  }
                    ...
                    <div className="p-5">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-0.5">
                          ...
                          <Link href={`/editor/templates/${template.id}/edit`}>
                            <Button
                              variant="ghost"
                              size="icon"
                              className="h-7 w-7 text-muted-foreground hover:text-primary"
                      ...
                      {/* Use Template button */}
                      <Link href={`/editor/posts/create?template=${template.id}`} className="block mt-3">
                        <Button
                          size="sm"
