            ...
            {clubs.docs.length === 0 ? (
              <tr>
                <td colSpan={6} className="p-8 text-center text-muted-foreground">
                  No clubs found.{' '}
                  <Link href="/user/clubs/create" className="text-accent hover:underline">
                    Create one
                  </Link>
                </td>
              </tr>
      ...
      {clubs.totalPages > 1 && (
        <div className="flex items-center justify-between mt-4">
          ...
          <div className="flex gap-2">
            {(clubs.page ?? 1) > 1 && (
              <Link href={`/user/clubs?page=${(clubs.page ?? 1) - 1}`}>
